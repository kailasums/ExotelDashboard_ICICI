...
<head>
    ...
    <meta name="csrf-token" content="ZBlQvltMSYMH-bPSq60J11SjQaixAeFCcj_BXw1jQ3YAYSaHayEEsmGSg57JnWGYIPIU0eJnths8WKlqPyt3OA==">
...
<span class="icon-bar"></span>
<span class="icon-bar"></span></button><a class="navbar-brand" href="/dashboard"><img src="images/logo.png" alt=""></a></div><div id="w5-collapse" class="collapse navbar-collapse"><ul id="w6" class="navbar-nav navbar-right nav"><li class="nav-item dropdown"> 
                  <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="icn-user"></i>Welcome NSM</a>
                   <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    <a class="dropdown-item" href="/site/change-password"><i class="icn-key"></i>Change password</a>
                     <a class="dropdown-item" href=""><i class="icn-logout"></i><form action="/site/logout" method="post">
<input type="hidden" name="_csrf" value="ZBlQvltMSYMH-bPSq60J11SjQaixAeFCcj_BXw1jQ3YAYSaHayEEsmGSg57JnWGYIPIU0eJnths8WKlqPyt3OA=="><button type="submit">Logout</button></form></a>
                    </div> 
            ...
            <div class="col-md-3">
                <div class="card">
                   <!--  <input type="hidden" name="googlechart1" value='[["Status","Calls"]]'> -->
                    <div id="piechart4" class="bigPieChart">
                        <div  id="div-chartw0"></div>                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="card">
                    <div id="piechart" class="bigPieChart">
                        <div  id="div-chartw1"></div>                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card">
                    <div id="piechart2" class="bigPieChart">
                        <div  id="div-chartw2"></div>                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card">
                    <div id="piechart3" class="bigPieChart">
                        <div  id="div-chartw3"></div>                    </div>
                </div>
            </div>
        </div>
        </div>
    ...
    <div class="filters-listing card">
      ...
      <div class="filters-category" id="statusOption">
        <div class='form-group checkbox'>
                        <input type='checkbox' class='charecter-filter report-status-filter' value='Cancellations' id='Cancellations'  />
                          <label for='Cancellations'>Cancellations</label>
                      </div><div class='form-group checkbox'>
                        <input type='checkbox' class='charecter-filter report-status-filter' value='Completed' id='Completed'  />
                          <label for='Completed'>Completed</label>
                      </div><div class='form-group checkbox'>
                        <input type='checkbox' class='charecter-filter report-status-filter' value='In Progress' id='In Progress'  />
                          <label for='In Progress'>In Progress</label>
                      </div><div class='form-group checkbox'>
                        <input type='checkbox' class='charecter-filter report-status-filter' value='Invalid' id='Invalid'  />
                          <label for='Invalid'>Invalid</label>
                      </div><div class='form-group checkbox'>
                        <input type='checkbox' class='charecter-filter report-status-filter' value='Modify' id='Modify'  />
                          <label for='Modify'>Modify</label>
                      </div><div class='form-group checkbox'>
                        <input type='checkbox' class='charecter-filter report-status-filter' value='On Hold' id='On Hold'  />
                          <label for='On Hold'>On Hold</label>
                      </div><div class='form-group checkbox'>
                        <input type='checkbox' class='charecter-filter report-status-filter' value='Scheduled' id='Scheduled'  />
                          <label for='Scheduled'>Scheduled</label>
                      </div><div class='form-group checkbox'>
                        <input type='checkbox' class='charecter-filter report-status-filter' value='Unscheduled' id='Unscheduled'  />
        ...
        <div class="form-group selectType">
              <div class="select">
                  <select name="type" form="type" class="wo-type-filter form-control">
                    ...
                    <option value='ASC' >ASC</option><option value='Field Repair' >Field Repair</option><option value='Installation' >Installation</option><option value='MORE OTT Installation' >MORE OTT Installation</option><option value='MORE OTT Recovery' >MORE OTT Recovery</option><option value='MORE OTT Repair' >MORE OTT Repair</option><option value='MPEG4 Migration' >MPEG4 Migration</option><option value='Other Services' >Other Services</option><option value='Project' >Project</option><option value='Relocation' >Relocation</option><option value='Upgrade' >Upgrade</option>                  </select>
              </div>
          </div>
          <div class="form-group selectType">
              <div class="select">
        ...
        <div class="form-group selectType">
              <div class="select">
                  <select name="type" form="type" class="wo-priority-filter form-control">
                    ...
                    <option value='1-ASAP' >1-ASAP</option><option value='2-High' >2-High</option><option value='3-Medium' >3-Medium</option><option value='4-Low' >4-Low</option><option value='5-Escalation' >5-Escalation</option><option value='6-CSSO' >6-CSSO</option><option value='4-Interim Escltn' >4-Interim Escltn</option>                  </select>
              </div>
          </div>
      </div>
...
</div>                        <div class="col-md-10 pad-left">
...
<div class="input-group date"><input type="text" id="datepickerFilter2" class="form-control" name="EndDate" value="23-09-2020" data-date-container="#datepicker1" data-provide="#datepicker1"><span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span></div><div id="datepicker">
</div>
<div id="datepicker1">
</div>
<a id="reset-link-filter" class="reset-link" href="javascript:void(0)">Reset All</a>
    ...
    <div class="form-group selectType col-md-2">
        <div class="select">
            <select class="form-control user-regions-filter" name="tupe" form="type">
              ...
              <option value='10' >East</option><option value='14' >North</option>            </select>
        </div>
    </div>
    ...
    <div class="form-group selectType col-md-2">
        ...
        <a id="reset-advance-filter" class="reset-link" href="javascript:void(0)">Reset Advance Search</a></div>
                                    </div>
                                
<div class="calls-table">
    <div class="grid-view">
        <div id="w4" class="list-view"><div class="empty">no data</div></div>    </div>
</div>
