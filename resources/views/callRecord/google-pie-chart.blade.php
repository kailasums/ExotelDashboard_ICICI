                        ...
                        <div class="col-md-12">
                            ...
                            <div style="margin-bottom:10px;margin-top:10px;background: white;/* height:50px; */padding:12px;float: left;width: 100%">
                                ...
                                <div class="selectType col-md-2">
                                    <div class="select">
                                        {!! Form::select('zone', (object) array_merge( [''=>'Zone'], (array) $zone), '',array('class' => 'user-regions-filter','form'=>"type")); !!}
                                    </div>
                                </div>

                                <div class="selectType col-md-2">
                                    <div class="select">
                                        {!! Form::select('region', (object) array_merge( [''=>'Region'], (array) $region), '',array('class' => 'user-regions-filter','form'=>"type")); !!}
                                    </div>
                                </div>

                                <div class="selectType col-md-2">
                                    <div class="select">
                                        {!! Form::select('branch', (object) array_merge( [''=>'Branch'], (array) $branch), '',array('class' => 'user-regions-filter','form'=>"type")); !!}
                                    </div>
                                </div>

                                <div class="selectType col-md-2">
                                    <div class="select">
                                        {!! Form::select('user', (object) array_merge( [''=>'PB'], (array) $user), '',array('class' => 'user-regions-filter','form'=>"type")); !!}
                                    </div>
                                </div>
                            ...
                            <div id="piechart-graph" class="graph-section in" style="background: white;margin-bottom: 20px;">
                                ...
                                <div class="row custom-padd" id="pie-chart-data" >
                                            ...
                                            <div id="piechart2" class="">
                                                <div id="div-chartw2">
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <p  style="font-size: 18px;color: black;/* font-weight: bold; */font-weight: 1000;">Avg Call Duration : <span style="font-weight: normal;" id="avgCalls"></span></p>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
