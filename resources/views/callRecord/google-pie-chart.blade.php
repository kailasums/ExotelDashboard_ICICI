                                    ...
                                    <div class="col-md-3">
                                        <div id="filters" class="col-md-12">
                                            ...
                                            <div class="filters-listing card">
                                                <a data-toggle="collapse" href="#statusOptionTab" aria-expanded="false" aria-controls="statusOptionTab">Filter<i class="icn-down-arrow"></i></a>
                                                <div class="filters-category in" id="statusOptionTab">
                                                    <div class="form-group selectType">
                                                        <div class="select">
                                                            {!! Form::select('zone', (object) array_merge( [''=>'Select Zone'], (array) $zone), '',array('class' => 'wo-type-filter form-control','form'=>"type")); !!}
                                                        </div>
                                                    </div>
                                                    <div class="form-group selectType">
                                                        <div class="select">
                                                            {!! Form::select('region', (object) array_merge( [''=>'Select Region'], (array) $region), '',array('class' => 'wo-type-filter form-control','form'=>"type")); !!}
                                                        </div>
                                                    </div>
                                                    <div class="form-group selectType">
                                                        <div class="select">
                                                            {!! Form::select('branch', (object) array_merge( [''=>'Select Branch'], (array) $branch), '',array('class' => 'wo-type-filter form-control','form'=>"type")); !!}
                                                        </div>
                                                    </div>
                                                    <div class="form-group selectType">
                                                        <div class="select">
                                                            {!! Form::select('user', (object) array_merge( [''=>'Select User'], (array) $user), '',array('class' => 'wo-type-filter form-control','form'=>"type")); !!}
                                                        </div>
                                                    </div>
                                                    <div class="form-group selectType">
                                                        <div class="select">
                                                            {!! Form::select('call_direction', (object) array_merge( [''=>'Select Direction'], (array) $call_direction), '',array('class' => 'wo-type-filter form-control','form'=>"type")); !!}
                                                        </div>
                                                    </div>
