            ...
            <nav id="w1" class="navbar-inverse navbar-fixed-top navbar">
                <div class="container">
                    <div class="navbar-header"><button type="button" class="navbar-toggle" data-toggle="collapse"
                            ...
                            href="/backend/web/index.php"><img src="<?php echo e(asset('images/logo.png')); ?>" alt=""></a></div>
...
</html><?php /**PATH /var/www/html/ISPCalling/resources/views/layouts/common-layout.blade.php ENDPATH**/ ?>